...
enum reg_id
{
	...
	REG_ID_BEEPIS_DISPLAY_RSET = 0x50,
	REG_ID_BEEPIS_BUZZER_FREQ = 0x51,
	REG_ID_BEEPIS_BUZZER_DUTY = 0x52,
	REG_ID_BEEPIS_VIBRO_FREQ = 0x53,
	REG_ID_BEEPIS_VIBROR_DUTY = 0x54,
